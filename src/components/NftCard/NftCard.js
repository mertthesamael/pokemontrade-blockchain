...
const NftCard = ({ id }) => {
  ...
  const cardStyle = {
    1: {
      img: "https://ipfs.io/ipfs/QmU2ynpBSGYta2Cwy3D1THL7nTLmB8m6rEVDmdstVemgdY",
      color: "aqua",
    },
    2: {
      img: "https://ipfs.io/ipfs/QmX4TsCKbHWdNBAgdhe4YFutgCYdM4XPVFHyAh5TNsUR2F",
      color: "#B3FFAE",
    },
    3: {
      img: "https://ipfs.io/ipfs/QmRChK8DtEMpir3E6MjBrvioax1HrkLfRbraqnnqtKQGFW",
      color: "orange",
    },
    4: {
      img: "https://ipfs.io/ipfs/QmTKeiEdQ5mZhq5SjYCJUHyHHrTFGb44idengnEbjzU7oM",
      color: "yellow",
    },
  };
      ...
      <Box pos="relative" display="flex" h="15rem" justifyContent="center">
        <Tilt className={styles.nftImg} onMove={mouseTracker} scale="1.4">
          <Box
            ...
            margin="0 auto"
            w="70%"
            boxShadow={`${shadowY}px ${shadowX}px 20px 25px ${cardStyle[id].color}`}
