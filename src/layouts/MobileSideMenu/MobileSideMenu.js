...
// MAYBE I CAN USE IT LATER BUT DONT THINK SO
  ...
  return (
    <Flex className={styles.mobileSideMenu} pos="relative" w="100vw" h="100vh">
      <Flex bgColor="black" w="100%" h="100%">
        <Text color="black" fontSize="20rem">
          MobileSideMenu
        </Text>
        <Flex
          pos="relative"
          ...
          h="100%"
          bgColor={
            userToken ? colors[userToken?.properties.name.value] : "#150050"
          }
        >
          {menuState && (
            <Box
        ...
        <Flex w="100%" h="100%" pos="absolute" right="0" bgColor="red"></Flex>
      </Flex>
      {children}
    </Flex>
  );
